...
@MapperScan(basePackages = "com.example.test.mapper", sqlSessionTemplateRef = "test3SqlSessionTemplate")

public class TestMyBatisConfig3 {
	// 配置数据源
	@Bean(name = "test3DataSource")
	public DataSource testDataSource(DBConfig3 testConfig) throws SQLException {
